...
```{r}
kmeans_pl = fviz_cluster(object = clust, data = social_marketing, geom = "point",
choose.vars = c("health_nutrition", "personal_fitness"), stand = FALSE, 
ellipse.type = "norm")
...
```{r}
kmeans_pl = fviz_cluster(object = clust, data = social_marketing, geom = "point",
choose.vars = c("food", "cooking"), stand = FALSE, 
ellipse.type = "norm")
